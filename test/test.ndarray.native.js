...
var sswap = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
...
tape( 'the function supports an `x` offset', opts, function test( t ) {
	...
	xe = new Float32Array( [ 1.0, 2.0, 6.0, 7.0, 8.0 ] );
	ye = new Float32Array( [ 3.0, 4.0, 5.0, 9.0, 10.0 ] );
...
tape( 'the function supports a `y` offset', opts, function test( t ) {
	...
	xe = new Float32Array( [ 8.0, 9.0, 10.0, 4.0, 5.0 ] );
	ye = new Float32Array( [ 6.0, 7.0, 1.0, 2.0, 3.0 ] );
...
tape( 'the function supports negative strides', opts, function test( t ) {
	...
	sswap( N, x, -2, x.length-1, y, -1, y.length-2 );

	xe = new Float32Array( [ 7.0, 2.0, 8.0, 4.0, 9.0 ] );
	ye = new Float32Array( [ 6.0, 1.0, 3.0, 5.0, 10.0 ] );
